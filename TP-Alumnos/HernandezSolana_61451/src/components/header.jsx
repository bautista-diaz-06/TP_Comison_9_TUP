     ...
     <header id="inicio">
      ...
      <nav className="barra-navegacion">
        <div className="marca">
          ...
          <span className="marca-nombre">Solana</span>
